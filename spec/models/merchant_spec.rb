...
RSpec.describe Merchant, type: :model do
  before :each do
    ...
    @invoice_10 = @customers[9].invoices.first
    ...
    @invoice_item_5 = create(:invoice_item, item_id: @item3.id, invoice_id: @invoice_8.id, status: 0, quantity: 100, unit_price: 90.7)
    @invoice_item_6 = create(:invoice_item, item_id: @item4.id, invoice_id: @invoice_9.id, status: 0, quantity: 100, unit_price: 90.7)
    @invoice_item_7 = create(:invoice_item, item_id: @item5.id, invoice_id: @invoice_10.id, status: 0, quantity: 100, unit_price: 90.7)
